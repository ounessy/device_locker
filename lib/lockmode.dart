...
const _channel = MethodChannel('com.ounessy.lockmode/kiosk_mode');

/// Channel used to send "kiosk mode" updates from platform.
const _eventChannel = EventChannel('com.ounessy.lockmode/kiosk_mode_stream');
...
Future<bool> startKioskMode() => _channel
    .invokeMethod<bool>('startLockTask')
    .then((value) => value ?? false);

Future<bool> startLockMode() => _channel
