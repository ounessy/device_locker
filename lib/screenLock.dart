...
class MyScreenLock extends StatefulWidget {
  const MyScreenLock({super.key});

  @override
  _MyScreenLockState createState() => _MyScreenLockState();
}

class _MyScreenLockState extends State<MyScreenLock> {
  @override
